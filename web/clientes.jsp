                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Registro de Clientes</h1>
                        ...
                        <div class="">
                            <div class="mb-3">
                                <a href="" class="d-sm-inline-block btn btn-sm btn-success shadow-sm px-4">Registrar</a>
                            </div>
                        </div>
                                    ...
                                    <table class="table table-bordered table-hover" id="dataTable" width="100%"
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="align-middle">Nombres Y Apellidos</td>
                                                <td class="align-middle">12345678</td>
                                                <td class="align-middle">correo@ejemplo.com</td>
